CREATE OR REPLACE FUNCTION public.create_admin_booking_with_lock(p_guest_name text, p_room_id uuid, p_check_in date, p_check_out date, p_nightly_rate numeric, p_status text DEFAULT 'pending'::text)
 RETURNS uuid
 LANGUAGE plpgsql
 SECURITY DEFINER
