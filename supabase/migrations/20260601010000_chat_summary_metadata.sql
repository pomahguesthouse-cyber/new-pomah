-- ============================================================
-- Chat summary metadata: timestamp for rate-limited regeneration.
-- Also returns the timestamp from get_autoreply_context so the
-- service layer can decide whether to skip a fresh summary.
-- ============================================================
...
DECLARE
  ...
  v_messages               jsonb   := '[]';
BEGIN
  SELECT id, ai_auto, COALESCE(chat_summary, ''), chat_summary_updated_at
  INTO   v_thread_id, v_ai_auto, v_chat_summary, v_chat_summary_updated_at
