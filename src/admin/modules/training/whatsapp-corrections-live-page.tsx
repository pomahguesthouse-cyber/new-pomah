    ...
    <div className="flex h-screen min-h-0 bg-[#f0f2f5] text-[#111b21]">
      <aside className="flex min-h-0 w-[380px] min-w-[320px] max-w-[420px] flex-col border-r bg-white">
        <div className="flex h-[58px] items-center justify-between bg-[#008069] px-4 text-white">
          ...
          <Button size="sm" variant="outline" className="h-7 rounded-full border-white/45 bg-white/10 px-3 text-xs text-white hover:bg-white/20 hover:text-white" disabled={loadingThreads} onClick={() => refetchChats()}>{loadingThreads ? <Loader2 className="mr-1 h-3 w-3 animate-spin" /> : <RefreshCw className="mr-1 h-3 w-3" />}Refresh</Button>
        </div>
