...
const AGENTS = [
  ...
  },
  {
    ...
    tips: [
      "Persona kreatif & ringkas — gaya travel-magazine tanpa hiperbola",
      "Default draft (publish=false) supaya admin review sebelum tayang",
      "Bisa instruksikan tone, focus topik (mis. event Buddhis, kuliner halal)",
    ],
  },
  {
    key: "manager",
